...
This release includes mostly bug fixing and improvements based on regular testing, and on user input after the CLARIAH summer school, and on the Gitter forum.
