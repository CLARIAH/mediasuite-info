...
>
> If you use the Media Suite and would like to cite it, please use its version number, and this reference paper: Ordelman, R., Melgar Estrada, L., Martínez Ortiz, C., & Noordegraaf, J. (2018). Media Suite: Unlocking Archives for Mixed Media Scholarly Research. *CLARIN Annual Conference*. Presented at the Pisa, Italy. Retrieved from http://www.ep.liu.se/ecp/article.asp?issue=159&article=014&volume=
